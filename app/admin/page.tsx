    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-sm font-medium text-gray-500 uppercase">Total Concerts</h3>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-3xl font-bold text-secondary mt-2">{publishedConcerts || 0}</p>
        </div>
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-sm font-medium text-gray-500 uppercase">Upcoming</h3>
          <p className="text-3xl font-bold text-light-blue mt-2">{upcomingConcerts || 0}</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Link
            ...
            className="flex items-center p-4 border-2 border-primary rounded-lg hover:bg-light-gray transition-colors"
          >
          ...
          <Link
            href="/admin/concerts"
            className="flex items-center p-4 border-2 border-secondary rounded-lg hover:bg-light-gray transition-colors"
          >
            ...
            <div>
              <h3 className="font-semibold text-secondary">Manage Concerts</h3>
              <p className="text-sm text-gray-600">View and edit all concerts</p>
            </div>
          </Link>
        </div>
      </div>
